...
namespace Labb_LinQ.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "CustomerId", "Date", "Status", "TotalAmount" },
                values: new object[,]
                {
                    { 1, 1, new DateTime(2026, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Levererad", 11999 },
                    { 2, 2, new DateTime(2026, 3, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Levererad", 9695 },
                    { 3, 3, new DateTime(2026, 3, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Behandlas", 18999 },
                    { 4, 4, new DateTime(2026, 3, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Levererad", 3499 },
                    { 5, 5, new DateTime(2026, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Skickad", 17494 },
                    { 6, 1, new DateTime(2026, 2, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Levererad", 899 },
                    { 7, 3, new DateTime(2026, 2, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "Levererad", 2546 },
                    { 8, 2, new DateTime(2026, 3, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "Skickad", 3496 },
                    { 9, 4, new DateTime(2026, 3, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Behandlas", 11896 },
                    { 10, 5, new DateTime(2026, 3, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Behandlas", 1299 }
                });
